                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="left">{{ $courierProductInfo->created_at->toDateTimeString() }}</td>
                                    <td class="left">{{ $courierProductInfo->courier_quantity }}&nbsp;
                                      {{ $courierProductInfo->courierType->unit->name }}
                                    </td>
                                    <td class="left">
                                        @php
                                            $total_tk += $courierProductInfo->courier_fee;
                                        @endphp
                                        {{ $courierProductInfo->courier_fee }}
                                        {{ $gs->base_currency_symbol }}
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                            ...
                            <table class="table table-clear">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="right">
                                            <strong><span class="totalPrice">{{$total_tk}}</span> {{ $gs->base_currency_symbol }}</strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="left">
